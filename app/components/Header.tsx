      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <Link href="/" className="flex items-center ml-2 transition-all duration-300 hover:opacity-80">
          {!imageError ? (
            ...
            <span className="text-3xl font-bold text-gradient-holographic transition-all duration-300 glow-text-cyan">
              BEE SCALE-UP
            </span>
          )}
        </Link>
            ...
            {loading ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-3 px-4 py-2 rounded-full glass-light hover:glass transition-all duration-300 border border-white/20 hover:border-cyan-500/50 hover:glow-cyan"
                >
                  <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center shadow-lg glow-cyan">
                  ...
                  <svg
                    className={`w-4 h-4 text-cyan-400 transition-transform duration-200 ${userMenuOpen ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <>
                ...
                <Link 
                  href="/register"
                  className="btn-futuristic transform hover:-translate-y-1"
                  style={{ fontFamily: 'Space Grotesk, sans-serif' }}
                >
                  Sign Up
                </Link>
