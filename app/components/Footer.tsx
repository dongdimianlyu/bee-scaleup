          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <Link 
                ...
                className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 transform hover:scale-110 glow-cyan"
              >
