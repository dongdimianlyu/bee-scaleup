          ...
          >
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-2xl p-6">
              <div className="flex items-center">
                ...
                <div>
                  <h3 
                    className="text-lg font-bold text-yellow-800 mb-1"
                    style={{ fontFamily: 'Exo 2, sans-serif' }}
                  >
                    Setup Required
                  </h3>
                  <p className="text-yellow-700" style={{ fontFamily: 'Exo 2, sans-serif' }}>
                    Please complete {incompleteTasks.length} remaining task{incompleteTasks.length !== 1 ? 's' : ''} to activate your judge account.
                  </p>
                </div>
              </div>
            </div>
